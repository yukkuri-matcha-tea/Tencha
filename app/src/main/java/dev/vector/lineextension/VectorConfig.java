...
public class VectorConfig {
  ...
  public final Item enhanceOtherProfiles         = item("enhance_other_profiles",           OPT_OTHER_PROFILE_VIEWER_LABEL,             OPT_OTHER_PROFILE_VIEWER_DESC,             true,  Category.PRIVACY,      SEC_PRIVACY_PROFILE);
